...
export const KpiSkeleton = memo(function KpiSkeleton() {
  return (
    <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-[#1E1F28] dark:bg-[#111218] dark:shadow-none">
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-3 w-full">
          {/* Label skeleton */}
          <div className="h-3.5 w-24 animate-pulse rounded bg-gray-200 dark:bg-[#1E1F28]" />
          
          {/* Value skeleton */}
          <div className="h-8 w-16 animate-pulse rounded bg-gray-200 dark:bg-[#1E1F28]" />
          
          {/* Trend skeleton */}
          <div className="flex items-center gap-1.5 mt-1">
            <div className="h-3.5 w-12 animate-pulse rounded bg-gray-200 dark:bg-[#1E1F28]" />
            <div className="h-3.5 w-20 animate-pulse rounded bg-gray-200 dark:bg-[#1E1F28]" />
          </div>
        </div>

        {/* Icon skeleton */}
        <div className="h-10 w-10 shrink-0 animate-pulse rounded-lg bg-gray-200 dark:bg-[#1E1F28]" />
      </div>
    </div>
  );
});
